...
class ScalingUtility {
  ...
  Size figmaPhonePort = const Size(360, 640); ///-- mobile view port (360,640)
  ...
  void setCurrentDeviceSize() {
    ...
    if (!kIsWeb &&
        (currentDeviceSize.height / currentDeviceSize.width) != (figmaPhonePort.height / figmaPhonePort.width)
      ){
