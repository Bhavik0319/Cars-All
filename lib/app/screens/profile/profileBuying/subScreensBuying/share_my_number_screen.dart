...
class ShareMyNumberScreen extends GetView<ProfileController> {
  const ShareMyNumberScreen({super.key});
              ...
              Row(
                ...
                children: [
                  ...
                  Obx(
                    () {
                      return Switch(
                        value: UserStore.to.user.value.isPhoneShare!,
                        activeTrackColor: AppColors.secondaryLight,
                        activeColor: Colors.white,
                        inactiveThumbColor: AppColors.primaryLight,
                        onChanged: (e) {
                          UserStore.to.user.value.isPhoneShare = e;
                          controller.updateProfile({"isPhoneShare":e});
                        },
                      );
                    }
                  ),
