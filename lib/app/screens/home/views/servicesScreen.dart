...
import 'package:cars_and_alll/app/screens/home/widgets/homeBanner.dart';
...
class ServicesScreen extends GetView<CarDetailController> {
                            ...
                            child: Obx(
                              () {
                                return Text(
                                  ...
                                  style: controller.currentTab.value != 1 ? CustomTextStyle.txtPoppins10W400.copyWith(
                                    fontSize: scale.getScaledFont(12),
                                    color: AppColors.black2020,
                                  ) : CustomTextStyle.txtPoppins10W400.copyWith(
                                    fontSize: scale.getScaledFont(12),
                          ...
                          Tab(
                            child: Obx(
                              () {
                                return Text(
                                  'CIBIL Score Scheck',
                                  style: controller.currentTab.value != 2 ? CustomTextStyle.txtPoppins10W400.copyWith(
                                    fontSize: scale.getScaledFont(12),
                                    color: AppColors.black2020,
                                  ) : CustomTextStyle.txtPoppins10W400.copyWith(
                                    fontSize: scale.getScaledFont(12),
