                  ...
                  children: [
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              controller.updateSelectedCategory(category.categoryName!);
                            },
                            child: Container(
                              margin: scale.getMargin(
                                right: 5,
                              ...
                              child: Obx(
                                () {
                                  return CategoryTile(
                                    category: category,
                                    isSelected: controller.selectedCategory.value == category.categoryName ? true : false,
                                    scale: scale,
                                  );
                                }
                              ),
                    ...
                    Container(
                      ...
                      child: TabBar(
                        ...
                        onTap: (index) {
                          Get.find<CarDetailController>().changeTabIndex(index);
                        },
                        tabs: [
                          Tab(
                            child: Row(
                              children: [
                                Obx(
                                  () {
                                    return Text(
                                      'All cars',
                                      style: Get.find<CarDetailController>().currentTab.value != 0 ? CustomTextStyle.txtPoppins10W400.copyWith(
                              ...
                              children: [
                                Obx(
                                  () {
                                    return Text(
                                      'Vintage Cars',
                                      style: Get.find<CarDetailController>().currentTab.value != 1 ? CustomTextStyle.txtPoppins10W400.copyWith(
                                        fontSize: scale.getScaledFont(12),
                                        color: AppColors.black2020,
                                      ) : CustomTextStyle.txtPoppins10W400.copyWith(
                                        fontWeight: FontWeight.w600,
                              ...
                              children: [
                                Obx(
                                  () {
                                    return Text(
                                      'Commercial cars',
                                      style: Get.find<CarDetailController>().currentTab.value != 2 ? CustomTextStyle.txtPoppins10W400.copyWith(
                                        fontSize: scale.getScaledFont(12),
                                        color: AppColors.black2020,
                                      ) : CustomTextStyle.txtPoppins10W400.copyWith(
                                        fontSize: scale.getScaledFont(12),
