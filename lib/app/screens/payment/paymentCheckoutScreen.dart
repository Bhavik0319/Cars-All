...
class PaymentCheckoutScreen extends GetView<PaymentController>{
                              ...
                              child: Consumer(
                                  builder: (context, ref, child) {
                                    return ListView.builder(
                                      itemCount: controller.paymentInitialComponent.length,
                                      shrinkWrap: true,
                                            ...
                                            children: [
                                              Expanded(
                                                ...
                                                child: Align(
                                                  alignment: Alignment.topLeft,
                                                  child: Text(
                                                    controller.paymentInitialComponent[index],
                                              ...
                                              Expanded(
                                                ...
                                                child: Align(
                                                  alignment: Alignment.topRight,
                                                  child: Text(
                                                    controller.paymentInitialComponentAmount[index],
                                                    style: CustomTextStyle.txtPoppins10W400.copyWith(
                                                      fontSize: scale.getScaledFont(10),
                                                      color: AppColors.black,
                                                    ),
